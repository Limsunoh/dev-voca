 ...
 * 문제풀이 영역 전체의 마지막 방어선.
 *
 * **여기 있는 이유가 나가는 길 때문이다.** /test 아래 문제 화면들은
 * 탭바를 숨기므로(routes 의 immersiveRoutes 참고 - 허브·일일공부·복습은
 * 탭바가 있다) 나가는 문이 각 화면의 ExitGuard 하나뿐인데, 에러 경계는
 * 그 화면을 통째로 갈아치운다. 그러면 나가기 버튼도 같이 사라진다.
 *
